...
gmaps_key=googlemaps.Client(key = "AIzaSyBe6WcFrCAuPkS0R2Ab_2ZZFLEnlUJgdO0")
...
while(n!=16):
	...
	for x in range(1, 7):
		try:
			...
			browser1.quit()
			dict={"area":ae,"area_unit":area_unit,"building_name":building_name,"city":c,"country":country,"description":d,"expected_rent":e,"floor_count":floor_count,"landmark":landmark,"pincode":pincode,"property_image":[img],"street":street,"title":t,"latitude":lat,"longitude":lon}
			print(dict)
			with open('/home/ubuntu/AH_One/Appear_Here_data.json', 'a') as file:
